  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      <style>{`
        ...
        .setting-group select { padding: 0.6rem 0.75rem; border: 1px solid var(--border-color); border-radius: var(--radius-md); font-size: 0.9rem; background: var(--bg-surface); color: var(--text-primary); }
